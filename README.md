...
* Screensaver is disabled by default during audio playback. You can deactivate this setting to reinstate it. 
...
* Settings allow to define a background images during playback, with three main settings:
